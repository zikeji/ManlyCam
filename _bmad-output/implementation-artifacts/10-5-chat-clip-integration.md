...
- **ClipChatMessage fields**: `messageType: 'clip'`, `clipId: string`, `clipThumbnailUrl: string`, `clipName: string`, `clipDurationSeconds: number`, `tombstone?: true`. When `tombstone === true`, render the "clip unavailable" card.
